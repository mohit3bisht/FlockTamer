 ...
 * Fragment showing on the introduction slide at 3rd position.
 */
@SuppressLint("ValidFragment")
public class IntroCustomSearchFragment extends Fragment {
    private RelativeLayout mgetStarted;

    private WelcomeScreenInterface mCallback;

    public IntroCustomSearchFragment(WelcomeScreenInterface callback) {
        // Required empty public constructor
        mCallback = callback;
    }
public IntroCustomSearchFragment(){
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_intro_custom_search, container, false);
