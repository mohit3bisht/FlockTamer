 ...
 * * Fragment showing on the introduction slide at 2nd position.
 */
@SuppressLint("ValidFragment")
public class IntroCompanyFragment extends Fragment {
    private RelativeLayout mgetStarted;

    private WelcomeScreenInterface mCallback;

    public IntroCompanyFragment(WelcomeScreenInterface callback) {
        // Required empty public constructor
        mCallback = callback;
    }

    public IntroCompanyFragment(){
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_intro_company, container, false);
