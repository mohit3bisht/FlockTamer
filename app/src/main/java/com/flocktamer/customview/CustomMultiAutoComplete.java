 ...
 */
public class CustomMultiAutoComplete extends MultiAutoCompleteTextView implements AdapterView.OnItemClickListener {
    ...
    public CustomMultiAutoComplete(Context context) {
        super(context);
    }

    public CustomMultiAutoComplete(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public CustomMultiAutoComplete(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
    }

    public CustomMultiAutoComplete(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    public void setChips() {
        if (getText().toString().contains(",")) // check comman in string
        {
            ...
            for (String c : chips) {
                ...
                TextView textView = (TextView) lf.inflate(R.layout.view_company_select_item, null);
