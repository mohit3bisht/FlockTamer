 ...
 */
public class KeywordSkimAdapter extends RecyclerView.Adapter<KeywordSkimAdapter.StockViewHolder> {

    private List<String> mList;

    public KeywordSkimAdapter(List<String> list) {
        mList = list;
    }
    ...
    public StockViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View view = inflater.inflate(R.layout.view_keyword_item, parent, false);
